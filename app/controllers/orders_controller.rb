class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:readyorpo, :customer_id, :order_ids => [],:inventory_orders_attributes => [:id, :quantity, :inventory_id ])
