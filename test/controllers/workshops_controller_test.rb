...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { craft_image: @workshop.craft_image, description: @workshop.description, publish_status: @workshop.publish_status, title: @workshop.title, user_id: @workshop.user_id }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { craft_image: @workshop.craft_image, description: @workshop.description, publish_status: @workshop.publish_status, title: @workshop.title, user_id: @workshop.user_id }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
